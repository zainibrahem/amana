...
export default function ShopModal (props) {
    ...
    useEffect(()=>{
      ...
      function useOutsideAlerters(ref) {
        useEffect(() => {
            ...
            function handleClickOutside(event) {
                if (event.target.id == "overlays" && ref.current && !ref.current.contains(event.target)) {
                        props.handleModal()
                    }
            }
      ...
      useOutsideAlerters(modalReds);
    return(
        <div id="overlays"  className={` ${Modal?"block":"hidden"} left-0 top-0  fixed w-screen h-screen bg-black bg-opacity-80  z-50`}>
            <div ref={modalReds} className={`positionTopmobile ${Modal?"slideUps":"slideDowns"}  overflow-hidden modal rounded grid grid-cols-12 w-3/4 md:w-2/3  bg-white relative left-1/2 top-1/2 transform -translate-y-2/4 -translate-x-2/4`} style={{minHeight:"32.1rem"}}>
                    <div className="col-span-12  flex flex-row-reverse justify-between items-center relative " style={{background:`url(${props.shop.cover_image})`}}>
                        <div className="absolute top-0 left-0 w-full h-full  bg-opacity-70 bg-black"></div>
                        <div className="w-2/3 flex flex-row-reverse justify-start items-center z-10">
                            <svg className="w-1/4" xmlns="http://www.w3.org/2000/svg"  width="124.336" height="133.429" viewBox="0 0 124.336 133.429">
                            <defs>
                                ...
                                <image width="211" height="131" xlinkHref={props.shop?props.shop.image:""}/>
                                </pattern>
                            ...
                            <div className="flex flex-col justify-between items-center text-white">
                                ...
                                <span className="text-md">
                                    عضو  :{props.shop.member_since}
                                </span>
                            </div>
                        </div>
                        <div className="w-1/3 flex justify-between items-center px-4 z-10 text-white">
                            ...
                            <div className="border-r-2 w-1 h-16 mr-3"></div>
                            <div className="flex flex-col justify-center items-center">
                                <span className="numbers">4</span>
                                <span className="text-lg">
                                    منتجات فعالة
                    ...
                    <div className="grid grid-cols-12 bg-white rounded mt-12 p-3" dir="rtl">
                        <div className="col-span-12 p-2 rounded ">
