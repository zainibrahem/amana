            ...
            <nav className="w-full bg-white shadow-md h-16 flex justify-between items-center ">
                ...
                <div className="relative mx-3" x-data="{dropdown : false}">
                    ...
                    <div className="w-full  h-full flex justify-end  items-center px-3">
                        {searchIcon?
                        <svg onClick={togglesearch} xmlns="http://www.w3.org/2000/svg" className='mr-3 ml-3' width="18.179" height="18.179" viewBox="0 0 18.179 18.179">
                        ...
                        <button className="hidden ml-3 w-8 md:w-10 h-6  md:h-8 lg:h-10 lg:w-10 bg-gray-300 focus:outline-none hover:bg-gray-400 rounded-full md:flex items-center justify-center">
                        ...
                        <div onClick={toggleprofile} className="hidden ml-3 cursor-pointer w-8 md:w-10 h-6  md:h-8 lg:h-10 lg:w-10 focus:outline-none hover:bg-gray-400 rounded-full md:flex items-center justify-center" style={{background:"url('./images/user.jpg')",backgroundSize:"cover",backgroundPosition:"center"}}>
                        </div>
