...
<div className="fixed top-0 w-full z-30" style={{direction:"rtl"}}>
   <nav className="w-full bg-white shadow-md h-16 flex justify-between items-center ">
        ...
        <div className="flex border-b-4 border-white">
                <button className="flex items-center h-full w-16 lg:w-9 xl:w-9 justify-center  bg-white hover:bg-gray-200 focus:outline-none rounded-md">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="134.034" height="22.087" viewBox="0 0 134.034 22.087">
    ...
    <svg className="absolute z-30 top-0 my-2 mx-2  stroke-current text-gray-600  w-4 h-4 lg:w-5 lg:h-5 " xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="none" stroke="#b0b0b0" stroke-width="2" stroke-linecap="square" stroke-linejoin="round"><circle cx="11" cy="11" r="7"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg> */}
        ...
        <div className="w-full  h-full flex justify-end  items-center px-3">
         ...
         <form id="logout-form" action="{{ route('logout') }}" method="POST" style={{display:"none"}}>
            ...
            <button className="ml-3 w-8 h-8 lg:h-10 lg:w-10 bg-gray-300 focus:outline-none hover:bg-gray-400 rounded-full flex items-center justify-center">
            ...
            <button className="relative ml-3 w-8 h-8 lg:h-10 lg:w-10 bg-gray-300 focus:outline-none hover:bg-gray-400 rounded-full flex items-center justify-center">
                ...
                <div className="absolute top-0 right-0 w-6 h-6 text-white -mr-2 rounded-full bg-red-500">
                    3
                </div>
            </button>
            <button className="ml-3 w-8 h-8 lg:h-10 lg:w-10 bg-gray-300 focus:outline-none hover:bg-gray-400 rounded-full  flex items-center justify-center">
