            ...
            <div className="fixed top-0 w-full z-50 md:z-30" style={{direction:"rtl"}}>
                <nav className="w-full bg-white shadow-md h-16 flex justify-between items-center ">
                        ...
                        <div className={`hidden md:flex w-full  h-full justify-center ${Loading?"items-center":""}`}>
                            <div className={`${Loading?"skeleton-box rounded ":"border-yellow-500 "}border-b-4 `}>
                                <div  className={`h-full md:w-16 lg:w-24 xl:w-16`} style={Loading?{opacity:"0"}:{}}>
                                    <a href="/" className="flex items-center h-full md:w-16 lg:w-24 xl:w-16 justify-center  bg-white hover:bg-gray-200 focus:outline-none rounded-md">
                            ...
                            <div className={`${Loading?"skeleton-box rounded  mr-2":"border-b-4 "} border-white`}>
                                <div className={`h-full md:w-16 lg:w-24 xl:w-16`} style={Loading?{opacity:"0"}:{}}>
                                    <a href="/stores" className="flex items-center h-full md:w-16 lg:w-24 xl:w-16 justify-center  bg-white hover:bg-gray-200 focus:outline-none rounded-md">
                            ...
                            <div className={`${Loading?"skeleton-box rounded  mr-2":"border-b-4 "} border-white`}>
                                <div className={`h-full md:w-16 lg:w-24 xl:w-16`} style={Loading?{opacity:"0"}:{}}>
                                <a href="/offers" className="flex items-center h-full md:w-16 lg:w-24 xl:w-16 justify-center  bg-white hover:bg-gray-200 focus:outline-none rounded-md">
                        ...
                        <>
                            ...
                            <div style={Loading?{opacity:"0"}:{}}>
                                <img src="/images/icons/ddddddd.svg" className="w-4 h-4 lg:w-6 lg:h-6"  alt="" />
