...
export default function ProductCard () {
    ...
    return (
        <>
            <div className="cards relative left-1/2 transform -translate-x-2/4 flex flex-col justify-center items-center rounded shadow-md w-44 sm:w-52 mb-3" style={{direction:"ltr"}}>
                ...
                <div className="flex flex-col justify-between items-center w-full px-2 py-2 info">
                    ...
                    <div className="text-xs flex flex-col justify-between items-center mt-2 relative desc">
                        ...
                        <div className={counter?"opacity-0 mt-2 transition-all flex flex-row-reverse justify-between w-full items-center before-hover":"opacity-1 mt-2 transition-all flex flex-row-reverse justify-between w-full items-center before-hover"}>
                                <img className={counter?"opacity-0 transition-all w-14 h-2 ml-1":"w-14 h-2 ml-1"} src="https://z.nooncdn.com/s/app/com/noon/images/fulfilment_express_v2-ar.svg" alt="" />
