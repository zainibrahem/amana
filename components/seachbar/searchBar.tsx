...
export default function SearchBar () {
    ...
    return (
      <div>
        ...
        <div className={Filter?"transition-all overflow-hidden	duration-1000 ease-in-out delay-300 rounded w-full hidden md:flex flex-col justify-start items-center content-between  h-36 sm:h-80 bg-white shadow-md mt-7 mb-5 sm:mb-7":"transition-all overflow-hidden  duration-1000 delay-300 ease-in-out rounded w-full hidden md:flex flex-col justify-start items-center content-between h-16 bg-white shadow-md mt-7 mb-5 sm:mb-7"}>
        <div className="w-full flex justify-around items-center pt-3">
            <div className='w-9/12 relative'>
                <input type="text" className={`rounded w-full border-2 focus:outline-none text-right text-sm py-1 ${Loading?"skeleton-box":""}`}/>
    ...
    {search?
        <div className={Filter?"fixed slide-top left-0  transition-all overflow-hidden	duration-1000 ease-in-out delay-300 rounded w-full flex flex-col justify-start items-center content-between  h-36 sm:h-80 bg-white shadow-md mt-7 mb-5 sm:mb-7":"transition-all overflow-hidden  duration-1000 delay-300 ease-in-out rounded w-full flex flex-col justify-start items-center content-between h-16 bg-white shadow-md mt-7 mb-5 sm:mb-7 fixed slide-top left-0 "}>
            <div className="w-full flex justify-around items-center pt-3">
                <div className='w-9/12 relative'>
