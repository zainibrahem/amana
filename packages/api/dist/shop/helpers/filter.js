...
const filterOrder = (items, user, limit = 7, text) => __awaiter(void 0, void 0, void 0, function* () {
    let filteredItems = items;
    const fuse = new fuse_js_1.default(items, {
...
const getRelatedItems = (type, slug, items) => __awaiter(void 0, void 0, void 0, function* () {
    let filteredItems = items;
