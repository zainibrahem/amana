        ...
        <div className="grid grid-cols-12 mt-6">
            ...
            <div className="col-span-12 mt-6">
                        <div className="flex flex-row-reverse justify-between w-full items-center flex-wrap">
                            ...
                            <div className="flex flex-row-reverse justify-between items-center  text-gray-500 w-full">
                                <div className="flex flex-row-reverse justify-between items-center w-full">
                                    <div className='w-full relative hover:shadow-md'>
                                        <input type="text" dir="rtl" onChange={handleSearch}  placeholder="البحث عن المتاجر في أمانة..." className={`rounded  w-full h-full border-2 focus:outline-none text-right text-sm pr-2 lg:py-1 `}/>
                                        <button onClick={search} className={`text-xs sm:text-md rounded-r-none focus:outline-none flex justify-between items-center absolute left-0 top-0 h-full px-3 sm:px-5 lg:px-10 rounded bg-yellow-500`}>
                        ...
                        <div className="w-full flex  justify-between items-center mt-6">
                            <div className="grid grid-cols-12 gap-4 lg:grid-cols-10" dir="rtl">
