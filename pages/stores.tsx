        ...
        <div className="grid grid-cols-12 mt-6">
            ...
            <div className="col-span-12 mt-6">
                        <div className="flex flex-row-reverse justify-between w-full items-center flex-wrap">
                            ...
                            <div className="flex flex-row-reverse justify-between items-center px-3 text-gray-500 w-full lg:w-1/2 ">
                                ...
                                <div className='w-full relative'>
                                    ...
                                    <button className={`text-xs sm:text-md  focus:outline-none flex justify-between items-center absolute left-0 top-0 h-full px-3 sm:px-5 lg:px-10 rounded bg-yellow-500`}>
